...
@section('content')
    ...
    <div class="lg:mx-60 mx-5">
        ...
        <div class="lg:flex lg:justify-between lg:gap-3">
            ...
            <div class="lg:sticky lg:top-3 border rounded w-[350px] h-[600px] mt-5 lg:mb-0">
                <div class="mb-2">
                    ...
                    <div class="space-y-2">
                        @foreach ($other_informations as $key => $other_information)
                            <a href="{{route('information-detail', $other_information->slug)}}">
                                <div class="flex items-center gap-4 bg-gray-100 shadow-md p-2 rounded-lg border-l-4 border-red-500 mb-2">
