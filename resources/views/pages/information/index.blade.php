        ...
        <div class="mb-5">
            <form class="max-w-md mx-auto" method="GET" action="{{route('information')}}">
                ...
                <div class="relative">
                    ...
                    <button type="submit" class="text-white absolute end-2.5 bottom-2.5 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2" style="background-color: #D10000">Search</button>
                </div>
            </form>
        </div>
